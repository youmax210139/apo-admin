...
class FlySystemConfigUpdateRequest extends Request
{
    /**
    ...
    {
        return [
            'ident' => 'required|unique:fly_system_config,ident,' . $this->get('id') . '|max:64',
            'name' => 'required|unique:fly_system_config,name,' . $this->get('id') . '|max:64',
