...
class CreateTableBanks extends Migration
{
    ...
    public function up()
    {
        Schema::create('banks', function (Blueprint $table) {
            ...
            $table->string('ident', 30)->unique()->comment("唯一标识");
...
insert into banks (name, ident, disabled, withdraw) values('USDT虚拟钱包','USDT','0','1');
insert into banks (name, ident, disabled, withdraw) values('TRC20虚拟钱包','USDTTRC20','0','1');
";
        DB::unprepared($sql);
    }
