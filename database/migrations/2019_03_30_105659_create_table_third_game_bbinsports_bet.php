...
class CreateTableThirdGameBbinsportsBet extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('third_game_bbinsports_bet', function (Blueprint $table) {
            $table->increments('id');
    ...
    public function down()
    {
        if (app()->environment() != 'production') {
            Schema::dropIfExists('third_game_bbinsports_bet');
        }
    }
}
