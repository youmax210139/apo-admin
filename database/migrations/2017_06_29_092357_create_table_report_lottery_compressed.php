...
class CreateTableReportLotteryCompressed extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('report_lottery_compressed', function (Blueprint $table) {
            ...
            $table->index(['created_at', 'lottery_id', 'issue', 'price', 'bonus', 'rebate']);
        });
    }
    ...
    public function down()
    {
        if (app()->environment() != 'production') {
            Schema::dropIfExists('report_lottery_compressed');
        }
    }
}
