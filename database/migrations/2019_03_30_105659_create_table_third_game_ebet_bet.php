...
class CreateTableThirdGameEbetBet extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('third_game_ebet_bet', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->timestamp('pay_out_time')->nullable();
    ...
    public function down()
    {
        if (app()->environment() != 'production') {
            Schema::dropIfExists('third_game_ebet_bet');
        }
    }
}
