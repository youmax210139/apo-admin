...
class CreateTableReportLotteryTotal extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('report_lottery_total', function (Blueprint $table) {
    ...
    public function down()
    {
        if (app()->environment() != 'production') {
            Schema::dropIfExists('report_lottery_total');
        }
    }
}
