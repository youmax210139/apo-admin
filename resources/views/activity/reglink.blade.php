...
@section('title','邀请码注册统计')

@section('function','邀请码注册统计')
                ...
                <div class="box-body">
                    <table id="tags-table" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th class="hidden-sm">到达阶数</th>
                            <th class="hidden-sm">奖金</th>
                ...
                columnDefs: [
                    {
                        ...
                        "render": function (data, type, row) {
                            var str = '';
                            var row_verify = {{ Gate::check('activity/verify') ? 1 : 0 }};

                            if (row_verify && row.status == 0) {
                                str = '<a attr="' + row.id + '" username="' + row.username + '" prize="' + row.prize + '" href="javascript:;" class="btn-xs text-primary verify">审核</a>';
                            } else if (row.comment != '') {
