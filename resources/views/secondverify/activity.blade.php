...
@section('title','发放礼金审核')

@section('function','发放礼金审核')
        ...
        <div class="box box-primary">
            <form class="form-horizontal" id="search">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="created_admin" class="col-sm-3 col-sm-3 control-label">发放员</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name='created_admin' placeholder="发放员" />
                ...
                <table id="tags-table" class="table table-striped table-condensed table-bordered table-hover app_w100pct">
                    <thead>
                        <tr>
                            ...
                            <th class="hidden-sm">礼金金额</th>
                            <th class="hidden-sm" data-sortable="false">类型</th>
                            <th class="hidden-sm" data-sortable="false">活动</th>
                            <th class="hidden-sm" data-sortable="false">批注</th>
                            <th class="hidden-sm">发放员</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="lead">
                    ...
                    确认要<span class="row_verify_text"></span>该笔礼金吗?
                </p>
            </div>
...
$(function () {
 ...
 //审核
                $("table").delegate('.verify', 'click', function () {
                    ...
                    $('.verifyForm').attr('action', '/Verifyactivity/verify?id=' + id);
