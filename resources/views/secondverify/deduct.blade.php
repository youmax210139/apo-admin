...
@section('title','人工扣款审核')

@section('function','人工扣款审核')
            ...
            <form class="form-horizontal" id="search">
                ...
                <div class="box-body">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label for="status" class="col-sm-3 control-label">扣款类型</label>
                            <div class="col-sm-9">
                                <select name="order_type" class="form-control">
                                    <option></option>
                                    @foreach( $order_types as $order_type)
                                        <option value="{{$order_type->ident}}">{{$order_type->name}}</option>
                                    @endforeach
                                </select>
                                <p class="help-block">当前“扣款类型”查询条件慎用，会耗费资源.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="created_admin" class="col-sm-3 col-sm-3 control-label">扣款员</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name='created_admin' placeholder="扣款员" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <p class="help-block">当前“充值金额”查询条件慎用，会耗费资源.</p>
                            </div>
                        </div>
                ...
                <table id="tags-table" class="table table-striped table-condensed table-bordered table-hover app_w100pct">
                    <thead>
                        <tr>
                            ...
                            <th class="hidden-sm">扣款金额</th>
                            <th class="hidden-sm" data-sortable="false">扣款类型</th>
                            <th class="hidden-sm" data-sortable="false">批注</th>
                            <th class="hidden-sm">扣款员</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="lead">
                    ...
                    确认要<span class="row_verify_text"></span>该笔扣款吗?
                </p>
            </div>
...
$(function () {
 ...
 //审核
                $("table").delegate('.verify', 'click', function () {
                    ...
                    $('.verifyForm').attr('action', '/Verifydeduction/verify?id=' + id);
