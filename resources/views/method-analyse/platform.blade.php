...
@section('title','平台彩票玩法分析')
@section('function','平台彩票玩法分析')
@section('function_link','/methodanalyse/?mode=platform')
@section('here','平台彩票玩法分析')
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="box box-primary">
                <form class="form-horizontal">
                    ...
                    <div class="box-footer text-center">
                        ...
                        <button type="button" class="btn btn-default margin" onclick="location.href='/methodanalyse/?mode=user'"><i class="fa fa-retweet" aria-hidden="true"></i>用户模式</button>
                    </div>
                </form>
            </div>
            <div class="box box-primary">
