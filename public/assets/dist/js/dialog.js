var Modal = (function ($) {
    var $body = $(document.body),
        ...
        getTpl = function () {
            return ['<div class="modal modal-primary fade" data-backdrop="false" data-show="false" data-keyboard="false">',
        ...
        setContent: (function () {
            ...
            return function (content) {
                if(this.type !='undefined' && this.type !=''){
                    content = '<div class="text-'+this.type+'">'+content+'</div>'
                }
        ...
        Proxy = function (isAlert) {
            return function () {
                ...
                var msg = typeof arguments[0] === 'string' && arguments[0] || arguments[0].msg || '',
                    ...
                    type = typeof arguments[0] === 'string' && arguments[0] || arguments[0].type || '',
